...
public class CurrencyConversionController {
	...
	public CurrencyConversion calulateConversion(@PathVariable String from ,@PathVariable String to ,@PathVariable BigDecimal quantity) {
		
		HashMap<String,String> uriVariables =new HashMap<>();
		uriVariables.put("from", from);
		uriVariables.put("to", to);
		
		ResponseEntity<CurrencyConversion> resEntity= new RestTemplate().
	...
	public CurrencyConversion calulateConversionFeign(@PathVariable String from ,@PathVariable String to ,@PathVariable BigDecimal quantity) {
		
		
		proxy.retrieveValue(from, to);
